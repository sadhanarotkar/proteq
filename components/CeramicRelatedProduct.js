...
import React from 'react'
 ...
 const CeramicRelatedProduct = (props) => {
                  ...
                  { props.ceramic && <div className='item'>
                      <Link href={{
                        ...
                        <a className="relatedPBox">
                          ...
                          <p>Who wouldn't want their car to look as good and brand new as it did the day they got it. You thoroughly wash it</p>
                        </a>
                      </Link>
                    </div>}
                   ...
                   <Link href={{
                      ...
                      <a className="relatedPBox">
                          ...
                          <p>Infused with Patent-Pending Ceramic Glow Technology, with Features That Act as an Application Aid Allowing Users</p>
                        </a>
                      </Link>
                    </div>}
                    ...
                    <Link href={{
                      ...
                      <a className="relatedPBox">
                          ...
                          <p>One of the biggest problems with plastic parts like the front grille, headlight trim, or radiator covers is that bugs tend to end their lives</p>
                        </a>
                      </Link>
                    </div>}
                    ...
                    <Link href={{
                       ...
                       <a className="relatedPBox">
                          ...
                          <p>Having glass that is clean and clear is essential for driving, so it gives you the best visibility possible, which is especially important</p>
                        </a>
                      </Link>
                    </div>}
                  </div>
...
export default CeramicRelatedProduct;
