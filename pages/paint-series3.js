            ...
            <div className="category-nav mobTabs">
              <div className="nav nav-tabs category-tabs justify-content-center" id="nav-tab" role="tablist">
                <Link  href={{
                  ...
                  <a className="nav-item nav-link active">3.0 series</a>
                  <Link  href={{
                ...
                <div className="container-fluid">
                  ...
                  <div className="row justify-content-center">
                    ...
                    <div className="col-xl-5 col-lg-5 col-md-6 col-sm-12 text-left px-sm-5">
                      ...
                      <p>The 3.0 Paint Protection Film series comes in a Thermoplastic Polyurethane with 0.17mm ± 0.02mm thickness. It consists of three layers with a 35% increased brightness. It comes with Proteq’s Self Healing Technology and a 4-year warranty against manufacturing defects.</p>  
                    </div>
                  </div>
                </div> 
              </div>
            ...
            <div className="container-fluid">
              <div className="row justify-content-end align-items-center">
                ...
                <div className="col-xl-5 col-lg-5 col-md-5 pr-md-0 pl-md-5">
                  <img src="img/galleryImgs/img43.jpeg" className="img-fluid" />
                </div>
              </div>
            </div>
          </section>          
