                ...
                <div className="container-fluid">
                  ...
                  <div className="row justify-content-center">
                    ...
                    <div className="col-xl-5 col-lg-5 col-md-6 col-sm-12 text-left px-sm-5">
                      ...
                      <p>The 5.0 Paint Protection Film series comes in a Thermoplastic Polyurethane with 0.2mm ± 0.02mm thickness. It consists of three layers with 50% increased brightness. It comes with Proteq’s heat repair & Hydrophobic feature, 1.52m x 15m and Patent Coating and 3 years warranty against manufacturing defects.</p>  
                    </div>
                  </div>
                </div> 
              </div>
            ...
            <div className="container-fluid">
              <div className="row justify-content-end align-items-center">
                ...
                <div className="col-xl-5 col-lg-5 col-md-5 pr-md-0 pl-md-5">
                  <img src="img/galleryImgs/img60.jpeg" className="img-fluid" />
                </div>
              </div>
            </div>
          </section>
          <PaintRelatedProducts series2={true} series3={true} seriesm={true} />
          <ProductTestimonial />
